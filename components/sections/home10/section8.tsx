        ...
        <div className="contact10-bg-section">
                  ...
                  <div className="col-lg-6 col-md-6">
                    ...
                    >
                      ...
                      <div className="text">
                        ...
                        <a href="mailto:info@hushlushevents.com">
                          info@hushlushevents
                          <br />
                          .com
                        </a>
                  ...
                  <div className="col-lg-6 col-md-6">
                    ...
                    >
                      ...
                      <div className="text">
                        <h5>Call/Message</h5>
                        <div className="space14" />
                       <a href="tel:+97168850838">068850838</a>
          ...
          <div className="mapouter">
            <div className="gmap_canvas">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3605.806660140149!2d55.3864222!3d25.344268000000003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f5b4ad1f84c95%3A0x905e1932b1c879a2!2sAfaq%20Alkhaleej%20Management%20Consultants!5e0!3m2!1sen!2sin!4v1752236298790!5m2!1sen!2sin"
                width={600}
                height={450}
                style={{ border: 0 }}
                allowFullScreen
